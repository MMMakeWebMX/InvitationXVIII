  ...
  if (loading) {
    return (
      ...
      <section className="items-center justify-center h-screen w-screen flex flex-col text-center relative overflow-hidden">
        ...
        >
          <div className="animate-ping [animation-duration:3s]">
            <img src="../mis18.webp" alt="Mis!8" class="object-cover h-48" />
        <img src="../year.webp" alt="Mis!8" class="object-cover h-32" />
          </div>
        </div>
